...
for milliseconds_per_instance in GRANULARITIES:
    ...
    # ['num_window', 'roll_belt', 'pitch_forearm', 'yaw_belt', 'magnet_dumbbell_z','pitch_belt', 'magnet_dumbbell_z', 'roll_forearm', 'accel_dumbbell_y', 'roll_dumbbell', 'accel_dumbbell_y', 'accel_belt_x','accel_belt_y','accel_belt_z']
    ...
    # # Plot all data
    DataViz.plot_dataset(dataset, ['yaw_belt', "magnet_dumbbell_z", "pitch_belt", 'magnet_dumbbell_y', 'roll_forearm', 'label'],
